...
/*
    ...
    var postData = {
        ...
        const serviceType = response.data?.serviceType; // Using optional chaining
        if (serviceType) {
            // Property exists, do something with it
            console.log('Service Type:', serviceType);
        } else {
            // Property doesn't exist or is undefined
            console.log('Service Type is undefined in the response data');
        }
    }
    }
